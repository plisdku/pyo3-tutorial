...
Okee dokee. Then I made a branch, `issue/1`. Did some work, made a stupid sorting algorithm, then
...
(the `--fill` uses the last commit title and description). Merged it on github. This didn't close the issue though. I could have apparently written "Fixes #1" or "Closes #1" in the PR description somewhere. Yeah yeah ok.
...
Yeah, I gave myself a project to do here, but this is boring. Maybe I'll get back to my main project.